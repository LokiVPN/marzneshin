...
class ProxyTypes(StrEnum):
    ...
    VLESS: Final = "vless"
    Trojan: Final = "trojan"
    Shadowsocks: Final = "shadowsocks"
    Shadowsocks2022: Final = "shadowsocks2022"
    Hysteria2: Final = "hysteria2"
    WireGuard: Final = "wireguard"
    TUIC: Final = "tuic"
    ShadowTLS: Final = "shadowtls"


class InboundHostSecurity(StrEnum):
    INBOUND_DEFAULT: Final = "inbound_default"
    NONE: Final = "none"
    TLS: Final = "tls"
