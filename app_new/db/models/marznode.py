...
from app_new.core.common.proxy import (
    ProxyTypes,
    InboundHostSecurity,
    InboundHostFingerprint,
)
from app_new.db.models.base import Base, inbounds_services, hosts_services
from app_new.schemas.node import NodeStatus
