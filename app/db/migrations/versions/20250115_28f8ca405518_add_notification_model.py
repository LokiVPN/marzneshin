...
def upgrade() -> None:
    ...
    notifications = op.create_table('notifications',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('label', sa.String(length=128), nullable=False),
    sa.Column('message', sa.String(length=1024), nullable=False),
    sa.Column('action', sa.Enum('user_created', 'user_updated', 'user_activated', 'user_deactivated', 'user_deleted', 'user_enabled', 'user_disabled', 'data_usage_reset', 'subscription_revoked', 'reached_usage_percent', 'reached_days_left', 'get_bonus', 'custom', name='action'), nullable=False),
    ...
    op.create_table('notifications_targets',
    sa.Column('notification_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('sent_at', sa.DateTime(), nullable=True),
    sa.Column('skipped', sa.Boolean(), server_default=sa.text('0'), nullable=True),
